# Untitled undefined type in SalesResult Schema

```txt
#/properties/tickets/items/properties/passengers/items#/properties/tickets/items/properties/passengers/items/properties
```
