# Untitled undefined type in OperationalMessageToDriver Schema

```txt
https://schemas.ruter.no/adt/ota/api/v2.1/driver-interaction/operational-message-to-driver.json#/properties
```
