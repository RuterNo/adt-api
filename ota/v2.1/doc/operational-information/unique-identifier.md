# [v2.1](../../README.md) / [Operational information](README.md) / Unique identifier 
...
```txt
https://schemas.ruter.no/adt/ota/api/v2.1/operational-information/unique-identifier.json
```
