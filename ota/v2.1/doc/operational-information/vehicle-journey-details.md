# [v2.1](../../README.md) / [Operational information](README.md) / Vehicle journey details 
...
```txt
https://schemas.ruter.no/adt/ota/api/v2.1/operational-information/vehicle-journey-details.json
```
