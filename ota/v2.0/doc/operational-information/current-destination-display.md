# [v2.0](../../README.md) / [Operational information](README.md) / Current destination display 
...
```txt
https://schemas.ruter.no/adt/ota/api/v2.0/operational-information/current-destination-display.json
```
...
| [text](#text)                                   | `string` | Required | cannot be null | [CurrentDestinationDisplay](current-destination-display-properties-text.md "\#/properties/text#/properties/text")                                                    |
...
-   Type: `string`
-   cannot be null
-   defined in: [CurrentDestinationDisplay](current-destination-display-properties-text.md "\#/properties/text#/properties/text")
