# [v2.0](../../README.md) / [Proprietary extensions](README.md) / Doors individually 
...
```txt
https://schemas.ruter.no/adt/ota/api/v2.0/proprietary-extensions/doors-individually.json
```
