# [v2.0](../../README.md) / [Driver interaction](README.md) / Destination display override 
...
```txt
https://schemas.ruter.no/adt/ota/api/v2.0/driver-interaction/destination-display-override.json
```
