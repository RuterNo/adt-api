# [v2.0](../../README.md) / [Driver interaction](README.md) / Operational message to driver 
...
```txt
https://schemas.ruter.no/adt/ota/api/v2.0/driver-interaction/operational-message-to-driver.json
```
