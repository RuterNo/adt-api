# [v2.0](../../README.md) / [Extended information](README.md) / Deviation information 
...
```txt
https://schemas.ruter.no/adt/ota/api/v2.0/extended-information/deviation-information.json
```
